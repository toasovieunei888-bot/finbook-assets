...
var COLOR={'検討中':'#7d7565','仕入済':'#2c7fa3','未割当':'#7b58a3','作業中':'#e0901c',
...
var STAGE={'検討中':0,'仕入済':1,'未割当':2,'作業中':3,'保留':3,'要検品':4,
  '出品中':5,'査定中':5,'返送待ち':5,'売却済':6,'取消':-1};
/* 画面に出す言い方。シートに入る値は元のまま */
var LABEL={'検討中':'仕入れ検討','仕入済':'仕入れ済み','未割当':'リペア待ち','作業中':'リペア中',
...
var REQ=[
  {from:1,fields:['ブランド','型','仕入値']},
  {from:2,fields:['仕入先','仕入日','症状','リペア担当']},
...
/* いま何をすればいいか */
var TODO={
  '仕入済':'直す前の写真をとって、どこを直すかを選び、リペアの人を決める',
...
var PREV={'未割当':'仕入済','査定中':'出品中','返送待ち':'査定中','作業中':'未割当','要検品':'作業中','出品中':'要検品','売却済':'出品中'};
...
function updateWarn(){
  ...
  if(!cur){
    ...
    nl.innerHTML='<div class="nd">登録すると番号がついて、写真が撮れるようになります</div>';
    return;
  }
...
/* 流れのどこにいるかを並べて出す */
var FLOW=['仕入済','未割当','作業中','要検品','出品中','売却済'];
